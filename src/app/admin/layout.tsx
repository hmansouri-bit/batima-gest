    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      <aside className="w-64 bg-gray-900 dark:bg-gray-950 text-white flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <a href="/admin/annonces" className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition">
            📢 Annonces
          </a>
        </nav>
        <div className="p-4 border-t border-gray-700 flex items-center justify-between">
          <button
            ...
            className="px-3 py-2 text-red-400 hover:bg-gray-700 rounded-lg transition text-sm">
            🚪 Se déconnecter
          </button>
          <DarkModeToggle />
        </div>
